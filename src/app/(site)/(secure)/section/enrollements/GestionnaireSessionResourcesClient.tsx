      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            Ressources <strong>session</strong> avec <strong>matieres[]</strong>. Création en <strong>inactive</strong> ;
            activez lorsque l&apos;inscription doit être visible.
          </p>
        </div>
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5 pt-6">
                  ...
                  <div className="mt-auto flex flex-wrap gap-2 border-t border-gray-100 pt-4 dark:border-gray-800">
                    <Link
                      href={`/section/enrollements/sessions/${r.id}`}
