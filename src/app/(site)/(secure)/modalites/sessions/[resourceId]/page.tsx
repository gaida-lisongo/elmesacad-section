...
export const metadata: Metadata = {
  title: "Vérification paiement - Session | INBTP",
};

type PageProps = { params: Promise<{ resourceId: string }> };

export default async function ModalitesSessionCommandesPage({ params }: PageProps) {
  ...
  return (
    <EtudiantResourceCommandesClient
      ...
      toolbarDescription="Vérifiez les paiements des étudiants pour cette session d'enrôlement avant de valider leur accès."
    />
  );
}
