...
export const metadata: Metadata = {
  title: "Modalités - Relevés | INBTP",
};

export const dynamic = "force-dynamic";

export default async function ModalitesRelevesPage() {
  ...
  let resources: ReleveResourceRow[] = [];
  ...
  try {
    const [resourcesData, fraisData, modalitesData] = await Promise.all([
      ...
      listRessourceFraisAction({ resourceType: "releve" }),
      listModalitesForRessourceFraisAction(),
    ]);
  ...
  return (
    <ModalitesRessourceFraisClient
      resourceType="releve"
      resourceTypeLabel="Relevés"
      resourceTypeIcon="solar:document-text-bold-duotone"
      sectionSlug={scope.sectionSlug}
