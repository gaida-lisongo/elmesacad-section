      ...
      <form className="mt-4 space-y-3" onSubmit={onSubmit}>
        ...
        <div className="rounded-md border border-gray-200 p-3 dark:border-gray-700">
          <button
            type="button"
            onClick={askLocation}
            className="rounded-md border border-primary px-3 py-2 text-xs font-semibold text-primary transition hover:bg-primary/5 dark:border-primary dark:text-primary dark:hover:bg-primary/10"
          >
          ...
          className="w-full rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:bg-darkprimary disabled:opacity-50"
          >
