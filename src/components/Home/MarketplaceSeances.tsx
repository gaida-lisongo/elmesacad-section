              ...
              >
                ...
                <div className="space-y-3 p-4">
                  ...
                  <Link
                    ...
                    className="inline-flex w-full items-center justify-center rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:bg-darkprimary"
                  >
                    Consulter la seance
                  </Link>
                </div>
