...
import FraisCrud from "./FraisCrud";
...
export function DashboardAnneesArticle({
  ...
  return (
    <>
    {
      ...
      ) : (<article className="animate-dashboard-in rounded-xl border border-gray-200/80 bg-gradient-to-b from-white to-primary/5 p-4 shadow-sm transition duration-500 hover:shadow-md dark:border-gray-800 dark:from-gray-900 dark:to-primary/10 dark:hover:shadow-primary/10 lg:col-span-2"
